 ...
 */var zp;function T_(){if(zp)return go;zp=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var d=null;if(u!==void 0&&(d=""+u),l.key!==void 0&&(d=""+l.key),"key"in l){u={};for(var h in l)h!=="key"&&(u[h]=l[h])}else u=l;return l=u.ref,{$$typeof:o,type:r,key:d,ref:l!==void 0?l:null,props:u}}return go.Fragment=e,go.jsx=i,go.jsxs=i,go}var Bp;function b_(){return Bp||(Bp=1,Cf.exports=T_()),Cf.exports}var zt=b_(),Rf={exports:{}},ie={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ip;function A_(){if(Ip)return ie;Ip=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),x=Symbol.iterator;function _(U){return U===null||typeof U!="object"?null:(U=x&&U[x]||U["@@iterator"],typeof U=="function"?U:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,R={};function y(U,$,vt){this.props=U,this.context=$,this.refs=R,this.updater=vt||M}y.prototype.isReactComponent={},y.prototype.setState=function(U,$){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,$,"setState")},y.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function v(){}v.prototype=y.prototype;function z(U,$,vt){this.props=U,this.context=$,this.refs=R,this.updater=vt||M}var O=z.prototype=new v;O.constructor=z,b(O,y.prototype),O.isPureReactComponent=!0;var D=Array.isArray,G={H:null,A:null,T:null,S:null,V:null},V=Object.prototype.hasOwnProperty;function I(U,$,vt,St,K,ht){return vt=ht.ref,{$$typeof:o,type:U,key:$,ref:vt!==void 0?vt:null,props:ht}}function j(U,$){return I(U.type,$,void 0,void 0,void 0,U.props)}function w(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function C(U){var $={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(vt){return $[vt]})}var H=/\/+/g;function lt(U,$){return typeof U=="object"&&U!==null&&U.key!=null?C(""+U.key):$.toString(36)}function st(){}function gt(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(st,st):(U.status="pending",U.then(function($){U.status==="pending"&&(U.status="fulfilled",U.value=$)},function($){U.status==="pending"&&(U.status="rejected",U.reason=$)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function dt(U,$,vt,St,K){var ht=typeof U;(ht==="undefined"||ht==="boolean")&&(U=null);var xt=!1;if(U===null)xt=!0;else switch(ht){case"bigint":case"string":case"number":xt=!0;break;case"object":switch(U.$$typeof){case o:case e:xt=!0;break;case g:return xt=U._init,dt(xt(U._payload),$,vt,St,K)}}if(xt)return K=K(U),xt=St===""?"."+lt(U,0):St,D(K)?(vt="",xt!=null&&(vt=xt.replace(H,"$&/")+"/"),dt(K,$,vt,"",function(re){return re})):K!=null&&(w(K)&&(K=j(K,vt+(K.key==null||U&&U.key===K.key?"":(""+K.key).replace(H,"$&/")+"/")+xt)),$.push(K)),1;xt=0;var bt=St===""?".":St+":";if(D(U))for(var Nt=0;Nt<U.length;Nt++)St=U[Nt],ht=bt+lt(St,Nt),xt+=dt(St,$,vt,ht,K);else if(Nt=_(U),typeof Nt=="function")for(U=Nt.call(U),Nt=0;!(St=U.next()).done;)St=St.value,ht=bt+lt(St,Nt++),xt+=dt(St,$,vt,ht,K);else if(ht==="object"){if(typeof U.then=="function")return dt(gt(U),$,vt,St,K);throw $=String(U),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return xt}function P(U,$,vt){if(U==null)return U;var St=[],K=0;return dt(U,St,"","",function(ht){return $.call(vt,ht,K++)}),St}function Z(U){if(U._status===-1){var $=U._result;$=$(),$.then(function(vt){(U._status===0||U._status===-1)&&(U._status=1,U._result=vt)},function(vt){(U._status===0||U._status===-1)&&(U._status=2,U._result=vt)}),U._status===-1&&(U._status=0,U._result=$)}if(U._status===1)return U._result.default;throw U._result}var q=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)};function yt(){}return ie.Children={map:P,forEach:function(U,$,vt){P(U,function(){$.apply(this,arguments)},vt)},count:function(U){var $=0;return P(U,function(){$++}),$},toArray:function(U){return P(U,function($){return $})||[]},only:function(U){if(!w(U))throw Error("React.Children.only expected to receive a single React element child.");return U}},ie.Component=y,ie.Fragment=i,ie.Profiler=l,ie.PureComponent=z,ie.StrictMode=r,ie.Suspense=m,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=G,ie.__COMPILER_RUNTIME={__proto__:null,c:function(U){return G.H.useMemoCache(U)}},ie.cache=function(U){return function(){return U.apply(null,arguments)}},ie.cloneElement=function(U,$,vt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var St=b({},U.props),K=U.key,ht=void 0;if($!=null)for(xt in $.ref!==void 0&&(ht=void 0),$.key!==void 0&&(K=""+$.key),$)!V.call($,xt)||xt==="key"||xt==="__self"||xt==="__source"||xt==="ref"&&$.ref===void 0||(St[xt]=$[xt]);var xt=arguments.length-2;if(xt===1)St.children=vt;else if(1<xt){for(var bt=Array(xt),Nt=0;Nt<xt;Nt++)bt[Nt]=arguments[Nt+2];St.children=bt}return I(U.type,K,void 0,void 0,ht,St)},ie.createContext=function(U){return U={$$typeof:d,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:u,_context:U},U},ie.createElement=function(U,$,vt){var St,K={},ht=null;if($!=null)for(St in $.key!==void 0&&(ht=""+$.key),$)V.call($,St)&&St!=="key"&&St!=="__self"&&St!=="__source"&&(K[St]=$[St]);var xt=arguments.length-2;if(xt===1)K.children=vt;else if(1<xt){for(var bt=Array(xt),Nt=0;Nt<xt;Nt++)bt[Nt]=arguments[Nt+2];K.children=bt}if(U&&U.defaultProps)for(St in xt=U.defaultProps,xt)K[St]===void 0&&(K[St]=xt[St]);return I(U,ht,void 0,void 0,null,K)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(U){return{$$typeof:h,render:U}},ie.isValidElement=w,ie.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:Z}},ie.memo=function(U,$){return{$$typeof:p,type:U,compare:$===void 0?null:$}},ie.startTransition=function(U){var $=G.T,vt={};G.T=vt;try{var St=U(),K=G.S;K!==null&&K(vt,St),typeof St=="object"&&St!==null&&typeof St.then=="function"&&St.then(yt,q)}catch(ht){q(ht)}finally{G.T=$}},ie.unstable_useCacheRefresh=function(){return G.H.useCacheRefresh()},ie.use=function(U){return G.H.use(U)},ie.useActionState=function(U,$,vt){return G.H.useActionState(U,$,vt)},ie.useCallback=function(U,$){return G.H.useCallback(U,$)},ie.useContext=function(U){return G.H.useContext(U)},ie.useDebugValue=function(){},ie.useDeferredValue=function(U,$){return G.H.useDeferredValue(U,$)},ie.useEffect=function(U,$,vt){var St=G.H;if(typeof vt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return St.useEffect(U,$)},ie.useId=function(){return G.H.useId()},ie.useImperativeHandle=function(U,$,vt){return G.H.useImperativeHandle(U,$,vt)},ie.useInsertionEffect=function(U,$){return G.H.useInsertionEffect(U,$)},ie.useLayoutEffect=function(U,$){return G.H.useLayoutEffect(U,$)},ie.useMemo=function(U,$){return G.H.useMemo(U,$)},ie.useOptimistic=function(U,$){return G.H.useOptimistic(U,$)},ie.useReducer=function(U,$,vt){return G.H.useReducer(U,$,vt)},ie.useRef=function(U){return G.H.useRef(U)},ie.useState=function(U){return G.H.useState(U)},ie.useSyncExternalStore=function(U,$,vt){return G.H.useSyncExternalStore(U,$,vt)},ie.useTransition=function(){return G.H.useTransition()},ie.version="19.1.0",ie}var Fp;function K0(){return Fp||(Fp=1,Rf.exports=A_()),Rf.exports}var Mi=K0(),wf={exports:{}},_o={},Df={exports:{}},Uf={};/**
 * @license React
...
`),y.length>0&&(y+=`
`),v=["#define SHADER_TYPE "+i.shaderType,"#define SHADER_NAME "+i.shaderName,b].filter(Eo).join(`
`),v.length>0&&(v+=`
...
`)+`
`+v);const O=z+y+d,D=z+v+h,G=U1(l,l.VERTEX_SHADER,O),V=U1(l,l.FRAGMENT_SHADER,D);l.attachShader(R,G),l.attachShader(R,V),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function I(H){if(o.debug.checkShaderErrors){const lt=l.getProgramInfoLog(R).trim(),st=l.getShaderInfoLog(G).trim(),gt=l.getShaderInfoLog(V).trim();let dt=!0,P=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(dt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,G,V);else{const Z=N1(l,G,"vertex"),q=N1(l,V,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
