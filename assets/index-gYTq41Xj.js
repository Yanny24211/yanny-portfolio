 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hp;function C_(){return Hp||(Hp=1,function(o){function e(P,Z){var q=P.length;P.push(Z);t:for(;0<q;){var Mt=q-1>>>1,D=P[Mt];if(0<l(D,Z))P[Mt]=Z,P[q]=D,q=Mt;else break t}}function i(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var Z=P[0],q=P.pop();if(q!==Z){P[0]=q;t:for(var Mt=0,D=P.length,$=D>>>1;Mt<$;){var vt=2*(Mt+1)-1,St=P[vt],K=vt+1,ht=P[K];if(0>l(St,q))K<D&&0>l(ht,St)?(P[Mt]=ht,P[K]=q,Mt=K):(P[Mt]=St,P[vt]=q,Mt=vt);else if(K<D&&0>l(ht,q))P[Mt]=ht,P[K]=q,Mt=K;else break t}}return Z}function l(P,Z){var q=P.sortIndex-Z.sortIndex;return q!==0?q:P.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],g=1,v=null,x=3,y=!1,E=!1,C=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function U(P){for(var Z=i(p);Z!==null;){if(Z.callback===null)r(p);else if(Z.startTime<=P)r(p),Z.sortIndex=Z.expirationTime,e(m,Z);else break;Z=i(p)}}function G(P){if(C=!1,U(P),!E)if(i(m)!==null)E=!0,V||(V=!0,lt());else{var Z=i(p);Z!==null&&dt(G,Z.startTime-P)}}var V=!1,z=-1,j=5,w=-1;function R(){return M?!0:!(o.unstable_now()-w<j)}function H(){if(M=!1,V){var P=o.unstable_now();w=P;var Z=!0;try{t:{E=!1,C&&(C=!1,B(z),z=-1),y=!0;var q=x;try{e:{for(U(P),v=i(m);v!==null&&!(v.expirationTime>P&&R());){var Mt=v.callback;if(typeof Mt=="function"){v.callback=null,x=v.priorityLevel;var D=Mt(v.expirationTime<=P);if(P=o.unstable_now(),typeof D=="function"){v.callback=D,U(P),Z=!0;break e}v===i(m)&&r(m),U(P)}else r(m);v=i(m)}if(v!==null)Z=!0;else{var $=i(p);$!==null&&dt(G,$.startTime-P),Z=!1}}break t}finally{v=null,x=q,y=!1}Z=void 0}}finally{Z?lt():V=!1}}}var lt;if(typeof N=="function")lt=function(){N(H)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,gt=st.port2;st.port1.onmessage=H,lt=function(){gt.postMessage(null)}}else lt=function(){_(H,0)};function dt(P,Z){z=_(function(){P(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(P){P.callback=null},o.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<P?Math.floor(1e3/P):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(P){switch(x){case 1:case 2:case 3:var Z=3;break;default:Z=x}var q=x;x=Z;try{return P()}finally{x=q}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(P,Z){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var q=x;x=P;try{return Z()}finally{x=q}},o.unstable_scheduleCallback=function(P,Z,q){var Mt=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?Mt+q:Mt):q=Mt,P){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=q+D,P={id:g++,callback:Z,priorityLevel:P,startTime:q,expirationTime:D,sortIndex:-1},q>Mt?(P.sortIndex=q,e(p,P),i(m)===null&&P===i(p)&&(C?(B(z),z=-1):C=!0,dt(G,q-Mt))):(P.sortIndex=D,e(m,P),E||y||(E=!0,V||(V=!0,lt()))),P},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(P){var Z=x;return function(){var q=x;x=Z;try{return P.apply(this,arguments)}finally{x=q}}}}(Uf)),Uf}var Gp;function R_(){return Gp||(Gp=1,Df.exports=C_()),Df.exports}var Lf={exports:{}},Tn={};/**
 * @license React
...
`)+`
`+_);const N=B+M+d,U=B+_+h,G=U1(l,l.VERTEX_SHADER,N),V=U1(l,l.FRAGMENT_SHADER,U);l.attachShader(C,G),l.attachShader(C,V),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(H){if(o.debug.checkShaderErrors){const lt=l.getProgramInfoLog(C).trim(),st=l.getShaderInfoLog(G).trim(),gt=l.getShaderInfoLog(V).trim();let dt=!0,P=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(dt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,G,V);else{const Z=N1(l,G,"vertex"),q=N1(l,V,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
