...
#define LOW_PRECISION`),e}function sE(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===q1?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===Lv?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Ki&&(e="SHADOWMAP_TYPE_VSM"),e}function oE(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case _s:case vs:e="ENVMAP_TYPE_CUBE";break;case Mc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function lE(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case vs:e="ENVMAP_MODE_REFRACTION";break}return e}function cE(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case Y1:e="ENVMAP_BLENDING_MULTIPLY";break;case Kv:e="ENVMAP_BLENDING_MIX";break;case Jv:e="ENVMAP_BLENDING_ADD";break}return e}function uE(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function fE(o,e,i,r){const l=o.getContext(),u=i.defines;let d=i.vertexShader,h=i.fragmentShader;const m=sE(i),p=oE(i),g=lE(i),v=cE(i),x=uE(i),M=Jy(i),E=$y(u),C=l.createProgram();let y,_,B=i.glslVersion?"#version "+i.glslVersion+`
